...
public partial class AdminPage_Default : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("~/AdminPage/ElectricBill.aspx");
        }
    }
    ...
    {
        TextBox5.Text = Convert.ToString(Convert.ToInt32(TextBox4.Text) - Convert.ToInt32(TextBox3.Text));
        TextBox7.Text = Convert.ToString(Convert.ToInt32(TextBox5.Text) * 4);
    }
