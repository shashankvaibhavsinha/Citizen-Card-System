<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage/AdminPage.master" AutoEventWireup="true" CodeFile="GasBill.aspx.cs" Inherits="AdminPage_Default" %>

<script runat="server">

    protected void TextBox5_TextChanged(object sender, EventArgs e)
    {
        TextBox7.Text = Convert.ToString(700);
    }
</script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel4" runat="server">
        ...
        <div class="auto-style17">
            <asp:Panel ID="Panel5" runat="server" BackColor="#000099" CssClass="auto-style18" Font-Size="XX-Large" ForeColor="White">
                <div class="auto-style25">
                    <span class="auto-style19">Update Gas Bill</span><br />
                    <table class="auto-style20">
                        ...
                        <tr>
                            <td class="auto-style23">Refill Serial Number</td>
                            <td class="auto-style22">
                                <asp:TextBox ID="TextBox5" runat="server" CssClass="auto-style24" Width="250px" AutoPostBack="True" OnTextChanged="TextBox5_TextChanged"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style23">Refilling Date</td>
                            <td class="auto-style22">
        ...
        <br />
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT ConsumerId, CitizenId FROM tbl_GasDetail WHERE (CitizenId = @Cid)">
            <SelectParameters>
                <asp:Parameter Name="Cid" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" UpdateCommand="UPDATE tbl_GasConsumerDtl SET ConsumerId = @coi, RefillSerialNo = @rs, RefillDate = @rd, AmountPaid = @ap">
            <UpdateParameters>
                <asp:ControlParameter ControlID="TextBox2" Name="coi" PropertyName="Text" />
                <asp:ControlParameter ControlID="TextBox5" Name="rs" PropertyName="Text" />
                <asp:ControlParameter ControlID="TextBox6" Name="rd" PropertyName="Text" />
