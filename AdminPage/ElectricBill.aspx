<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage/AdminPage.master" AutoEventWireup="true" CodeFile="ElectricBill.aspx.cs" Inherits="AdminPage_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel4" runat="server">
        ...
        <div class="auto-style17">
            <asp:Panel ID="Panel5" runat="server" BackColor="#000099" CssClass="auto-style18" Font-Size="XX-Large" ForeColor="White">
                <div class="auto-style25">
                    <span class="auto-style19">Update Electricity Bill</span><br />
                    <table class="auto-style20">
                        ...
                        <tr>
                            <td class="auto-style23">Previous Reading</td>
                            <td class="auto-style22">
                                <asp:TextBox ID="TextBox3" runat="server" CssClass="auto-style24" Width="250px" AutoPostBack="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style23">Present Reading</td>
                            <td class="auto-style22">
                                <asp:TextBox ID="TextBox4" runat="server" CssClass="auto-style24" Width="250px" AutoPostBack="True" OnTextChanged="TextBox4_TextChanged"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style23">Total Unit</td>
                            <td class="auto-style22">
        ...
        <br />
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT ConsumerId, CitizenId FROM tbl_ElectricDetail WHERE (CitizenId = @Cid)">
            <SelectParameters>
                <asp:Parameter Name="Cid" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" UpdateCommand="UPDATE tbl_ElectricConsumerDtl SET ConsumerId = @coi, PreviousReading = @prev, PresentReading = @pres, TotalUnit = @tu, ConsumeDate = @cd, AmountPaid = @ap">
            <UpdateParameters>
                <asp:ControlParameter ControlID="TextBox2" Name="coi" PropertyName="Text" />
                <asp:ControlParameter ControlID="TextBox3" Name="prev" PropertyName="Text" />
                <asp:ControlParameter ControlID="TextBox4" Name="pres" PropertyName="Text" />
                <asp:ControlParameter ControlID="TextBox5" Name="tu" PropertyName="Text" />
