<%@ Page Title="" Language="C#" MasterPageFile="~/UserPage/UserPage.master" AutoEventWireup="true" CodeFile="UserTelephoneServices.aspx.cs" Inherits="UserPage_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1 style="text-align: center; color: #FFFFCC; height: 100px; background-color: #800000" __designer:mapid="b36">
        ...
        <span class="auto-style15">Telephone Services</span></h1>
    <br />
    <asp:Panel ID="Panel5" runat="server" CssClass="auto-style21">
        <asp:MultiView ID="MultiView1" runat="server">
            <asp:View ID="View1" runat="server">
                <asp:Image ID="Image2" runat="server" Height="353px" ImageUrl="~/images/tele.jpg" Width="547px" />
            </asp:View>
            <asp:View ID="View2" runat="server">
                <asp:Panel ID="Panel10" runat="server" CssClass="auto-style23">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource10" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" UpdateCommand="UPDATE tbl_TelephoneConsumerDtl SET STDAmount = 0, ISDAmount = 0, LocalAmount = 0, TotalAmountConsumed = 0, AmountPaid = 0 WHERE (ConsumerId = @coi)">
                        <UpdateParameters>
            ...
            <asp:View ID="View3" runat="server">
                <asp:Panel ID="Panel7" runat="server" CssClass="auto-style24">
                    ...
                    <table class="auto-style37">
                        <tr>
                            <td class="auto-style29">Telephone Number</td>
                            <td class="auto-style30">
                                ...
                                <cc1:TextBoxWatermarkExtender runat="server" Enabled="True" TargetControlID="TextBox1" ID="TextBox1_TextBoxWatermarkExtender" WatermarkText ="Telephone Number"></cc1:TextBoxWatermarkExtender>
                            ...
                            <tr>
                                <td class="auto-style36" colspan="2">
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" InsertCommand="INSERT INTO tbl_TelephoneDetail(TelephoneNo, CompanyName, Status, ConnectionDate, CitizenId) VALUES (@tn, @cn, @s, @cd, @cid)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>">
                                        <InsertParameters>
                                            <asp:ControlParameter ControlID="TextBox1" Name="tn" PropertyName="Text" />
                                            <asp:ControlParameter ControlID="TextBox3" Name="cn" PropertyName="Text" />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT ConsumerId, CitizenId FROM tbl_TelephoneDetail WHERE (CitizenId = @cid)">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="cid" SessionField="Cid" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                    <asp:SqlDataSource ID="SqlDataSource7" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" InsertCommand="INSERT INTO tbl_TelephoneConsumerDtl(ConsumerId, STDAmount, ISDAmount, LocalAmount, TotalAmountConsumed, ConsumeDate, AmountPaid) VALUES (@coi, @std, @isd, @la, @ta, @cd, @ap)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>">
                                        <InsertParameters>
                                            <asp:ControlParameter ControlID="Label1" DefaultValue="" Name="coi" PropertyName="Text" />
                                            <asp:Parameter DefaultValue="0" Name="std" />
                                            <asp:Parameter DefaultValue="0" Name="isd" />
                                            <asp:Parameter DefaultValue="0" Name="la" />
                                            <asp:Parameter DefaultValue="0" Name="ta" />
                                            <asp:ControlParameter ControlID="TextBox4" Name="cd" PropertyName="Text" />
                        ...
                        <table class="auto-style37">
                            ...
                            <tr>
                                <td class="auto-style36" colspan="2">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT TelephoneNo, CompanyName, Status, ConnectionDate, CitizenId FROM tbl_TelephoneDetail WHERE (CitizenId = @cid)">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="cid" SessionField="Cid" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" UpdateCommand="UPDATE tbl_TelephoneDetail SET TelephoneNo = @tn, CompanyName = @cn, Status = @s, ConnectionDate = @cd WHERE (CitizenId = @cid)">
                                        <UpdateParameters>
                                            <asp:ControlParameter ControlID="TextBox5" Name="tn" PropertyName="Text" />
                                            <asp:ControlParameter ControlID="TextBox7" Name="cn" PropertyName="Text" />
                ...
                <asp:View ID="View5" runat="server">
                    <asp:Panel ID="Panel9" runat="server" CssClass="auto-style24">
                        ...
                        <table class="auto-style26">
                            <tr>
                                <td class="auto-style43" colspan="2">Are you Sure? Do you want to Close your Telephone Connection?</td>
                            </tr>
                            <tr>
                        ...
                        <br />
                        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM tbl_TelephoneDetail WHERE (CitizenId = @cid)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT ConsumerId FROM tbl_TelephoneDetail WHERE (CitizenId = @cid)">
                            <DeleteParameters>
                                <asp:SessionParameter Name="cid" SessionField="Cid" />
                            </DeleteParameters>
                            <SelectParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM tbl_TelephoneConsumerDtl WHERE (ConsumerId = @coi)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>">
                            <DeleteParameters>
        ...
        <br />
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT CitizenId, ConsumerId FROM tbl_TelephoneDetail WHERE (CitizenId = @Cid)">
            <SelectParameters>
                <asp:SessionParameter Name="Cid" SessionField="Cid" />
            </SelectParameters>
        </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT ConsumerId, AmountPaid FROM tbl_TelephoneConsumerDtl WHERE (ConsumerId = @coi)">
        <SelectParameters>
            <asp:ControlParameter ControlID="Label4" Name="coi" PropertyName="Text" />
        </SelectParameters>
    </asp:SqlDataSource>
